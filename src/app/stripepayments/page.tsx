        ...
        <div className=" flex flex-col items-center  gap-6 pt-2 md:w-1/2 md:items-start md:gap-10 md:pt-32 md:text-left">
          ...
          <Balancer>
           ...
           <div className="flex justify-center mt-4">         
              <Link href="https://docs.stripe.com/payments?payments=popular" target="_blank" className="border-black w-fit rounded-xl border-2 bg-black px-4 py-2 text-white transition-all hover:border-black hover:bg-black hover:bg-transparent hover:text-black/90">
                Learn more
              </Link>        
            </div>
